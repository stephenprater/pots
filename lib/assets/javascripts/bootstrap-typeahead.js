...
function ($) {
    ...
    Typeahead.prototype = {
        ...
        select: function () {
            ...
            this.$element.trigger('typeahead.beforeSelect',[this.$element.val(), $selectedItem.text()])
            this.$element.val($selectedItem.text()).change();
            this.$element.trigger('typeahead.select', [$selectedItem.text()])
            return this.hide();
        },
        ...
        keypress: function (e) {
            ...
            switch (e.keyCode) {
                case 13:
                   ...
                   console.log("return from trigger")
                   e.preventDefault();
                   break;
                case 9:
                   // tab
                   console.log('key press 9')
                   if (!this.shown) {
                      this.$element.val('')
                    } else {
